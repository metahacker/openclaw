...
<Response>
   ...
   *
   * Token is passed as a <Parameter> instead of a query param because
   * Twilio strips query parameters from the Stream URL before connecting
   * to the WebSocket. Parameters arrive in start.customParameters.
   *
